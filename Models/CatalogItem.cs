...
namespace eShopPorted.Models
{
    public class CatalogItem
    {
        ...
        // Bulk discount: minimum quantity to qualify for discount
        [Range(0, 10000000, ErrorMessage = "The field Discount Threshold must be a positive number.")]
        [Display(Name = "Discount Threshold (qty)")]
        public int? DiscountThreshold { get; set; }

        // Bulk discount: percentage off when threshold is met
        [Range(0, 30, ErrorMessage = "The field Discount Percentage must be between 0 and 30.")]
